/*!
   ...
   V2.95b.20100101+DEV.20100307
*/

/*jslint white: true, onevar: true, undef: true, nomen: false, eqeqeq: true, plusplus: false, bitwise: true, regexp: true, newcap: true, immed: true */
...
function SoundManager(smURL, smID) {
	...
	this.version = null;
	this.versionNumber = 'V2.95b.20100101+DEV.20100307';
	this.movieURL = null;
	this.url = (smURL || null);
	this.altURL = null;
	...
	*/
	...
	this._createMovie = function (smID, smURL) {
		...
		oEmbed, oMovie, tmp, movieHTML, oEl, oD, oToggle, oTarget, extraClass, s, x, oDebug;
		...
		if (oTarget) {
			...
			extraClass = (_s.debugMode ? ' sm2-debug' : '') + (_s.debugFlash ? ' flash-debug' : '');
