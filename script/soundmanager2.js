...
function SoundManager(smURL, smID) {
  ...
  this.useFlashCacheBusting = true;  // append SoundManager2 version number to SWF url to prevent client cache
  ...
  _createMovie = function(smID, smURL) {
    ...
    if (_s.useFlashCacheBusting) {
      smURL += '?' + encodeURIComponent(_s.versionNumber);
    }
