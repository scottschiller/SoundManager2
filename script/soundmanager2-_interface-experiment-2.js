...
console.log(s.position);
    ...
    function _oncaptiondata(oData) {
      ...
      if (_iO.oncaptiondata) {
        _iO.oncaptiondata.apply(s, [oData]);
      }
    ...
    function _onconnect(bSuccess) {
      ...
      if (bSuccess) {
        ...
        if (_iO.onconnect) {
          _iO.onconnect.apply(s, [bSuccess]);
        }
    ...
    console.log('SMSound interface', this);
