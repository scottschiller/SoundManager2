  ...
  */
  ...
  SMSound = function(oOptions) {
    ...
    this._onmetadata = function(oMetaData) {
      ...
      //_s._wD(fN);
      // contains a subset of metadata. Note files may have custom data.
