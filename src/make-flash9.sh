#!/bin/bash
/Applications/flexsdk/bin/mxmlc -optimize=true -use-network=false -o ../swf/soundmanager2_flash9.swf -file-specs "SoundManager2_AS3.as"
...
/Applications/flexsdk/bin/mxmlc -optimize=true -use-network=false -o ../swf/soundmanager2_flash9_nodebug.swf -file-specs "/tmp/SoundManager2_AS3.as"
