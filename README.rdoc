...
* <tt>fullURL</tt> specifies the full URL to the SWF file, bypassing any and all SWF path building.  This is useful when you need to include a cache-busting string in the URL, which is otherwise not possible.
